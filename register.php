    ...
    <script>
        function recoveremail() {
            ...
            if (user != null) {
                ...
                document.getElementById("pass1").value = user.password;
            }
        }
    </script>
...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <main class="px-3 loginBox">
        ...
        <div>
            ...
            <input id="pass1" class="inputBox" name="password1" type="password"/>
        ...
        <div>
            ...
            <input id="pass2" class="inputBox" name="password2" type="password" />
